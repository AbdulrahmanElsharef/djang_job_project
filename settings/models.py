...
class Company(models.Model):
    ...
    logo=models.CharField(_("icon"), max_length=50,default='logo.png')
    ...
    Fb_link=models.CharField(_("icon"), max_length=100)
    Gm_link=models.CharField(_("icon"), max_length=100)
    Tw_link=models.CharField(_("icon"), max_length=100)
    Yb_link=models.CharField(_("icon"), max_length=100)
