...
from companies.views import Employer_list, Employer_create, Employer_detail, Employer_update, Employer_delete,PostJob_choice
...
urlpatterns = [
    ...
    path('Employers/post', PostJob_choice, name='Employers_post'),  # functions
